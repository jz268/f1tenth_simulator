...
private:
    ...
    int nav_button_idx;
    int reactive_follow_gap_button_idx;
    ...
    std::string reactive_follow_gap_key_char;
...
public:
    BehaviorController() {
        ...
        n.getParam("reactive_follow_gap_button_idx", reactive_follow_gap_button_idx);
        // ***Add button index for new planner here***
        ...
        n.getParam("reactive_follow_gap_key_char", reactive_follow_gap_key_char);
        // ***Add key char for new planner here***
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        } else if (msg.buttons[reactive_follow_gap_button_idx]) {
            // gap follower
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == joy_key_char) {
            ...
            // nav
            toggle_mux(nav_mux_idx, "Navigation");
        } else if (msg.data == reactive_follow_gap_key_char) {
            // gap follower
            toggle_mux(gap_follower_mux_idx, "Gap Follower");
        }
        // ***Add new else if statement here for new planning method***
